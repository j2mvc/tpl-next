...
module.exports = __webpack_require__("hjNt");
...
/* harmony default export */ __webpack_exports__["a"] = (HtmlHeader);
...
var service = external_axios_default.a.create({
  ...
  // `keepAlive` 默认没有启用
  httpAgent: new external_http_default.a.Agent({
    keepAlive: true
  }),
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            params.apikey = config_default.a.apiKey;
            key = external_md5_default()(url + stringify_default()(params));

            if (!(config_default.a.cached && config_default.a.cached.has(key))) {
              _context.next = 5;
              break;
            }

            return _context.abrupt("return", config_default.a.cached.get(key));

          case 5:
            console.log('api get....', stringify_default()(params));
            return _context.abrupt("return", service({
              method: 'get',
              url: config_default.a.api + url,
              params: params,
              mode: 'no-cors'
            }).then(function (res) {
              ...
              if (json.code == 1) {
                if (config_default.a.cached && cache) {
                  // 数据存入缓存
                  config_default.a.cached.set(key, json);
                }
...
/* harmony default export */ var request = __webpack_exports__["a"] = ({
  get: get,
  post: post
});
...
/* harmony import */ var _request__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("VC3l");


var getList = function getList() {
  return _request__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].get({
    url: '/getCats',
    params: {
...
// EXTERNAL MODULE: ./api/request.js + 1 modules
var request = __webpack_require__("VC3l");

// CONCATENATED MODULE: ./api/modules.js
// 查找modules目录下的所有目录js文件
var files = __webpack_require__("STpb");
...
/* harmony default export */ var api_modules = (modules);
// CONCATENATED MODULE: ./api/index.js


/* harmony default export */ var api = __webpack_exports__["a"] = ({
  request: request["a" /* default */],
  modules: api_modules
});
...
// CONCATENATED MODULE: ./components/PageUI.js
...
var PageUI_NavbarItem = function NavbarItem(props) {
  return external_react_default.a.createElement("li", null, external_react_default.a.createElement(components_ActiveLink, {
    className: "nav",
    prefetch: true,
  ...
  }, props.item.name), external_react_default.a.createElement(style_default.a, {
    id: "918962882"
...
var PageUI_Navbar = function Navbar(props) {
  return external_react_default.a.createElement("ul", {
    ...
    return external_react_default.a.createElement(PageUI_NavbarItem, {
      key: item.id,
      item: item
    });
...
var PageUI = {
  Navbar: PageUI_Navbar
};
/* harmony default export */ var components_PageUI = __webpack_exports__["a"] = (PageUI);
...
/* harmony import */ var _assets_style_scss__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__("iFAD");
...
/* harmony import */ var _components_PageUI__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__("ci04");
/* harmony import */ var _components_HtmlHeader__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__("3orW");
/* harmony import */ var _api_request__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__("VC3l");
...
/*#__PURE__*/
function () {
  var _ref = Object(_babel_runtime_corejs2_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"])(
  /*#__PURE__*/
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            props = {};
            _context.next = 3;
            return _api__WEBPACK_IMPORTED_MODULE_10__[/* default */ "a"].request.get({
              url: '/getCats',
              params: {
                moduleId: '201412290839325502'
              },
...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(Page, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_components_HtmlHeader__WEBPACK_IMPORTED_MODULE_13__[/* default */ "a"], {
        title: this.props.title,
        keywords: this.props.keywords,
        description: this.props.description
      }), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_components_PageUI__WEBPACK_IMPORTED_MODULE_12__[/* default */ "a"].Navbar, {
    ...
    key: "getInitialProps",
    value: function () {
      var _getInitialProps = Object(_babel_runtime_corejs2_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"])(
      /*#__PURE__*/
...
var LRU = __webpack_require__("iDQ1"),
    options = {
  max: 500,
