...
var error_Error = function Error(props) {
  ...
  }, props.code), external_react_default.a.createElement("div", {
    className: "jsx-132161550" + " " + 'error-message'
  }, props.message), external_react_default.a.createElement(style_default.a, {
    id: "132161550"
  }, [".code.jsx-132161550{font-size:18px;color:#ff0000;}", ".error-message.jsx-132161550{font-size:18px;color:#3333;}"]));
};

/* harmony default export */ var components_error = (error_Error);
...
// EXTERNAL MODULE: ./components/PageUI.js + 1 modules
var PageUI = __webpack_require__("ci04");

// EXTERNAL MODULE: ./components/HtmlHeader.js
var HtmlHeader = __webpack_require__("3orW");

// EXTERNAL MODULE: ./assets/style.scss
var assets_style = __webpack_require__("iFAD");
...
function (_React$Component) {
  ...
  function Page() {
    ...
    return Object(possibleConstructorReturn["a" /* default */])(this, Object(getPrototypeOf["a" /* default */])(Page).apply(this, arguments));
  }
  ...
  Object(createClass["a" /* default */])(Page, [{
    ...
    value: function render() {
      if (this.props.error) {
        return external_react_default.a.createElement(components_error, {
          message: this.props.error.message,
          code: this.props.error.code
        });
      }

      return external_react_default.a.createElement("div", null, external_react_default.a.createElement(HtmlHeader["a" /* default */], {
        title: this.props.title,
        keywords: this.props.keywords,
        description: this.props.description
      }), external_react_default.a.createElement(PageUI["a" /* default */].Navbar, {
        list: this.props.list
      }), external_react_default.a.createElement("div", {
        className: "example"
      }, "Hello World!"), external_react_default.a.createElement("img", {
        src: "/static/test.jpg",
        alt: "my image"
      }));
    }
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                req = _ref.req;
                _context.next = 3;
                return api["a" /* default */].request.get({
                  url: '/getCats',
                  params: {
